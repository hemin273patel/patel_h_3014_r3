...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 02, 2018 at 05:17 PM
...
CREATE TABLE IF NOT EXISTS `tbl_user` (
  ...
  `user_time` tinyint(3) DEFAULT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_level`, `user_ip`, `user_time`) VALUES
(15, 'patel', 'hemin', 'hemin12345', 'hemin@gmail.com', NULL, '', '::1', 1),
(19, 'patel2', 'hemin22', 'hemin12345', 'he@g.com', NULL, '2', 'no', NULL);
COMMIT;
